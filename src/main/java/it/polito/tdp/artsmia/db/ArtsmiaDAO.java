...
//			se c'è un risultato andiamo a prenderlo. non c'è bisono del while
			if(res.next()) { 
...
//			ci aspetiamo più di una riga nei risultati, quindi while
			while(res.next()) { 
			int peso = res.getInt("C");
			int obj1 = res.getInt("eo1.object_id");
			int obj2 = res.getInt("eo2.object_id");
			
			adiacenze.add(new Adiacenza(obj1,obj2,peso));
			}
